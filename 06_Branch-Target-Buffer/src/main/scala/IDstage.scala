  ...
  switch(opcode) {
    ...
    is("b1100011".U) {
      ...
      switch(funct3){
        ...
        is("b001".U){ io.uop:=BNE ; validInstr:=true.B }
        is("b100".U){ io.uop:=BLT ; validInstr:=true.B }
        is("b101".U){ io.uop:=BGE ; validInstr:=true.B }
        is("b110".U){ io.uop:=BLTU; validInstr:=true.B }
        is("b111".U){ io.uop:=BGEU; validInstr:=true.B }
      }
    }
